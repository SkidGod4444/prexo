...
export default function PrexoWelcomeMail({ userName }: PrexoWelcomeMailProps) {
  return (
    <Html>
      <Head />
          ...
          <Container className="mx-auto w-full max-w-[600px] p-0">
            <Section className="p-8 text-center">
              ...
              <Text className="mb-8 text-lg leading-8">
                Welcome again! We're excited to have you on board. Get ready to
                integrate Prexo AI sales & support Agents in your apps.
              </Text>
              <Link
                href={baseUrl}
