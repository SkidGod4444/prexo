      ...
      <ResizablePanelGroup direction="horizontal" className="h-full w-full">
        <FramePanel className="flex h-full w-full bg-background overflow-hidden p-0 gap-0 rounded-xl">
          <ResizablePanel
            defaultSize={25}
            minSize={20}
            className="border-r-2 bg-secondary rounded-xl p-1 min-h-full flex flex-col overflow-hidden"
          >
            <ConvoPanel />
          </ResizablePanel>
          ...
          <ResizablePanel
            defaultSize={75}
            minSize={60}
            className="h-full bg-secondary rounded-xl flex flex-col overflow-hidden"
          >
            {children}
          </ResizablePanel>
        </FramePanel>
